# -*- org-download-image-dir: "~/Dropbox/pub/baty.net-hugo/static/img/2020"; org-download-method: directory; -*-
#+hugo_section: post
#+hugo_base_dir: ../
#+seq_todo: TODO DONE
...
:END:
*** DONE Org-roam :Orgmode:Roam:
CLOSED: [2020-02-08 Sat 12:12]
:PROPERTIES:
:EXPORT_FILE_NAME: org-roam
:ID:       0337D9F6-7FC0-4A33-8634-342118D3A20F
:END:
[[https://github.com/jethrokuan/org-roam][Org-roam]] is a new Emacs package by [[https://blog.jethro.dev/][Jethro Kuan]]. Here's his [[https://blog.jethro.dev/posts/introducing_org_roam/][blog post introducing
org-roam]].

I've a feeling this is going to be something. I've been using [[https://roamresearch.com][Roam]] for a while now
...
*** DONE Moving sites around :meta:sysadmin:
CLOSED: [2020-02-08 Sat 10:09]
:PROPERTIES:
:EXPORT_FILE_NAME: moving-sites-around
:END:

This is just me taking notes about where stuff is and where it's going,
server-wise.

[[https://jack.baty.net/2020/cloudron/][Running Cloudron]] has been a great experience, but I don't know that I can swing
...
First, everything is served using v2 of the [[https://caddyserver.com][Caddy web server]]. Caddy is
...
I've moved the static sites [[https://baty.net/][baty.net]] and [[https://static.baty.net/][static.baty.net]] there so far.

I've moved my [[https://gitea.io/en-us/][Gitea]] instance. Gitea is also written in Go so that was pretty easy.
I'm using Sqlite for the Gitea database, which keeps things simple.

Up next is node.js for my [[https://rudimentarylathe.org/][RudimentaryLathe.org]] wiki. The wiki is the only thing
remaining on that instance so once it's moved I can delete the instance.

For now I'm leaving Ghost ([[https://jack.baty.net/][jack.baty.net]]) and Lychee ([[https://galleries.baty.net/][galleries.baty.net]]) on
Cloudron since I get two apps there for free.

I recently mirrored the defunct [[https://copingmechanism.com][copingmechanism.com]] blog and dropped it into an
...
*** DONE Taika Waititi on Apple Keyboards
CLOSED: [2020-02-10 Mon 09:17]
:PROPERTIES:
:EXPORT_FILE_NAME: taika-waititi-on-apple-keyboards
:END:

[[https://twitter.com/Variety/status/1226710675554091008][Taika Waititi at the Oscars]]:
...
*** DONE How To Take Smart Notes With Org-mode - Jethro Kuan
CLOSED: [2020-02-15 Sat 09:13]
:PROPERTIES:
:EXPORT_FILE_NAME: how-to-take-smart-notes
:END:

[[https://blog.jethro.dev/posts/how_to_take_smart_notes_org/][Jethro Kuan]]:
...
I am still deciding between [[https://roamresearch.org][Roam]] and org-roam so this was helpful. And remember,
/it's the backlinks!/

*** DONE An app can be a home-cooked meal - Robin Sloan
CLOSED: [2020-02-15 Sat 13:09]
:PROPERTIES:
:EXPORT_FILE_NAME: an-app-can-be-a-home-cooked-meal
:END:

[[https://www.robinsloan.com/notes/home-cooked-app/#cooking-at-home][Robin Sloan]]:
...
*** DONE Brett Terpstra's 'Doing' utility :cli:
CLOSED: [2020-02-16 Sun 09:38]
:PROPERTIES:
:EXPORT_FILE_NAME: brett-terpstras-doing
:END:

[[https://brettterpstra.com/2020/02/14/scatterbrained-revisiting-the-doing-cli/][Brett Terpstra, revisiting the "doing" CLI]]:
...
I've not found a better way to do it than with [[https://brettterpstra.com/projects/doing/][doing]]. I've been using it for
years.

*** DONE Stop using encrypted email - Latacora
CLOSED: [2020-02-20 Thu 07:27]
:PROPERTIES:
:EXPORT_FILE_NAME: stop-using-encrypted-email
:END:

[[https://latacora.micro.blog/2020/02/19/stop-using-encrypted.html][Latacora]]:
...
*** DONE A long and binding road :emacs:
CLOSED: [2020-03-03 Tue 15:31]
:PROPERTIES:
:EXPORT_FILE_NAME: a-long-and-binding-road
:END:
...
CLOSED: [2020-09-01 Tue 16:20]
:PROPERTIES:
:EXPORT_FILE_NAME: 2020-09-01-test
:END:

Hi
*** DONE It's all Emacs :Emacs:
CLOSED: [2020-09-01 Tue 16:29]
:PROPERTIES:
:EXPORT_FILE_NAME: 2020-09-01-it-s-all-emacs
:ID:       71c030c8-d1e6-4b92-bcc2-c0ab0324a618
:END:


[[attachment:_20200901_162703wait-its-all-emacs.png]]

Always has been

(I never tire of this meme)
*** DONE Updates to my ox-hugo publishing setup :Emacs:Hugo:
CLOSED: [2020-09-01 Tue 17:25]
:PROPERTIES:
:EXPORT_FILE_NAME: 2020-09-01-updates-to-my-ox-hugo-publishing-setup
:END:

My [[https://www.baty.net/2020/its-all-emacs/][previous post]] was mostly a way to test updates to how I handle images and
publish posts using Org mode and [[https://github.com/kaushalmodi/ox-hugo][ox-hugo]].
...
that images are harder to manage. I'm letting [[https://orgmode.org/manual/Attachments.html][org-attach]] handle most of it. Image files
...
*** TODO 4x5 contact prints on 5x7 paper :Photography:Analog:Film:ATTACH:
:PROPERTIES:
:EXPORT_FILE_NAME: 2020-09-02-4x5-contact-prints-on-5x7-paper
:ID:       c34117e3-27a8-4bbd-b11c-5a1db2c80aae
:END:


[[attachment:_20200902_1719582020-09-02-4x5 contact prints on 5x7 paper.jpg]]
...
A few of the things I’m doing as of March 02, 2020
 ...
 - Reading [[https://www.goodreads.com/book/show/13838783-the-permanent-portfolio][The Permanent Portfolio]]
...
the web or mobile devices you should 💌 [[mailto:info@fusionary.com][send us a note]].


I blog here at [[https://www.baty.net/][baty.net]] ✒️ and at [[https://copingmechanism.com][copingmechanism.com]]

I've also been having a ball at my new wiki: [[https://rudimentarylathe.org][Rudimentary Lathe]].

You can email me at [[mailto:jack@baty.net][jack@baty.net]] ✉️. I still like receiving email!
...
- [[https://baty.net/][baty.net]] - My blog, since 2000
- [[https://rudimentarylathe.org/][rudimentarylathe.org]] - My life wiki (using Tiddlywiki)
- [[https://jack.baty.net/][jack.baty.net]] - A blog experiment using Ghost.
- [[https://tilde.club/~jbaty][tilde.club/~jbaty]] - because nostalgia is strong and Paul Ford is my hero

*Photography*

- [[https://flickr.com/photos/jbaty][Flickr]] - I've been posting photos to Flickr since forever. Flickr is still the
...
- [[https://twitter.com/jackbaty][@jackbaty]] on Twitter
