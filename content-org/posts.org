-*- mode: Org; org-download-image-dir: "~/sync/sites/blog/static/img"; -*-
#+hugo_section: post
#+hugo_base_dir: ../
#+seq_todo: TODO DONE
...
*** TODO My day so far in Roam and/or Emacs :Roam:Emacs:
:PROPERTIES:
:EXPORT_FILE_NAME: my-day-so-far-in-roam-andor-emacs
:END:
...
I blog here at [[https://www.baty.net/][baty.net]] ✒️
